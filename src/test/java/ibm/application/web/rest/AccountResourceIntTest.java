...
import ibm.application.config.Constants;
import ibm.application.domain.Authority;
import ibm.application.domain.PersistentToken;
import ibm.application.domain.User;
import ibm.application.repository.AuthorityRepository;
import ibm.application.repository.PersistentTokenRepository;
import ibm.application.repository.UserRepository;
import ibm.application.security.AuthoritiesConstants;
import ibm.application.service.MailService;
import ibm.application.service.UserService;
import ibm.application.service.dto.PasswordChangeDTO;
import ibm.application.service.dto.UserDTO;
import ibm.application.web.rest.errors.ExceptionTranslator;
import ibm.application.web.rest.vm.KeyAndPasswordVM;
import ibm.application.web.rest.vm.ManagedUserVM;
