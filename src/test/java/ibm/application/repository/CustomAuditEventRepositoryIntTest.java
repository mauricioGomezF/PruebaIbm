...
import ibm.application.config.audit.AuditEventConverter;
import ibm.application.domain.PersistentAuditEvent;
...
import static ibm.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
